                    ...
                    <div class="relative">
                        ...
                        <table class="min-w-full table-fixed divide-y divide-gray-300">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Prio
                                </th>
                            ...
                            <tr v-for="task in tasks" :key="task.id"
                                :class="[selectedTasks.includes(task.id) && 'bg-gray-50']">
                                ...
                                <td :class="['py-4 pr-3 text-sm font-medium whitespace-nowrap', selectedTasks.includes(task.id) ? 'text-indigo-600' : 'text-gray-900']">
                                    {{ task.title }}
                                </td>
